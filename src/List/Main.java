...
//
//        String stringData = "4 2 8 3 4 3 3 3 5 0 1 2 5 2 3 2 2 6 7 9";

        String stringData = "C B A G H D";
        String[] data = stringData.split(" ");
        System.out.println(Arrays.toString(data));
        for(String s: data){
            myLinkedList.add(new Node(s));
        }
...
//        myLinkedList.add(new Node("E"));
//        myLinkedList.add(new Node("C"));
//        myLinkedList.add(new Node("B"));
//        myLinkedList.traverse(myLinkedList.getRoot());
//        //myLinkedList.remove("");
//        myLinkedList.traverse(myLinkedList.getRoot());
